...
/**
 * Prolate spheroidal coordinates are useful e.g. for solving specific
 * differential equations. They are obtained from 2D elliptic coordinates by
 * rotating about the axis connecting their foci. Consequently, the foci
 * separated by 2<i>a</i> in elliptic coordinates remain points.
 * <p>
 * They are defined as follows:<br>
 * {@code x = a sinh(μ)sin(ν)cos(φ)}<br>
 * {@code y = a sinh(μ)sin(ν)sin(φ)}<br>
 * {@code z = a cosh(μ)cos(ν)}<br>
 * <p>
 * An example for a 2D cut (laying in the <i>xz</i> plane) through prolate
 * spheroidal coordinates with <i>a</i>=1:<br>
 * <img src="doc-files/prolate_spheroidal.png" alt="cut through prolate
 * spheroidal coordinates"><br>
 ...
 * separating the foci corresponds here to the <i>x</i> axis in
 * {@link CartesianCoordinates}. Rotation about the <i>z</i> axis yields the
 ...
 * @author Udo Hoefel
 */
@CoordinateSystemSymbols({"prolate_spheroidal"})
public final record ProlateSpheroidalCoordinates(NavigableSet<Axis> axes, Constant a) implements CoordinateSystem {
	 ...
	 * @param a the distance of the foci to the origin, needs to be larger than 0
	 */
	public ProlateSpheroidalCoordinates(Constant a) {
		this(DEFAULT_AXES, a);
	}
	...
	public double[] toBasePoint(double[] position) {
		...
		return Transformations.prolateSpheroidalToCartesian(position, a.value());
	}

	@Override
	public double[] fromBasePoint(double[] position) {
		double[] pointInCurrentSystem = new double[3];
		pointInCurrentSystem[0] = Maths.arcosh(0.5*Math.pow(a.value(),-1)*(Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)+Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)));
		pointInCurrentSystem[1] = (position[2]==0 ? 0 : (position[2]*Math.pow(Math.abs(position[2]),-1)*Math.acos(0.5*Math.pow(a.value(),-1)*(Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)-1*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)))));
	...
	public double[] toBaseVector(double[] position, double[] vector) {
		...
		vectorInBaseSys[0] = a.value()*Math.cos(position[2])*Math.cosh(position[0])*Math.sin(position[1])*vector[0]+a.value()*Math.cosh(position[0])*Math.sin(position[2])*Math.sin(position[1])*vector[1]+a.value()*Math.cos(position[1])*Math.sinh(position[0])*vector[2];
		vectorInBaseSys[1] = a.value()*Math.cos(position[2])*Math.cos(position[1])*Math.sinh(position[0])*vector[0]+a.value()*Math.cos(position[1])*Math.sin(position[2])*Math.sinh(position[0])*vector[1]+-1*a.value()*Math.cosh(position[0])*Math.sin(position[1])*vector[2];
		vectorInBaseSys[2] = -1*a.value()*Math.sin(position[2])*Math.sin(position[1])*Math.sinh(position[0])*vector[0]+a.value()*Math.cos(position[2])*Math.sin(position[1])*Math.sinh(position[0])*vector[1];
	...
	public double[] fromBaseVector(double[] position, double[] vector) {
		...
		vectorInCurrentSys[0] = 0.5*Math.pow(a.value(),-1)*Math.pow((-1+1.0/4*Math.pow(a.value(),-2)*Math.pow((Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)+Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)),2)),-1.0/2)*(position[0]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),-1.0/2)+position[0]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),-1.0/2))*vector[0]+(position[2]==0 ? 0 : (-1.0/2*position[2]*Math.pow(a.value(),-1)*Math.pow((1-1.0/4*Math.pow(a.value(),-2)*Math.pow((Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)-1*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)),2)),-1.0/2)*Math.pow(Math.abs(position[2]),-1)*(position[0]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),-1.0/2)-1*position[0]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),-1.0/2))))*vector[1]-1*position[1]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)),-1)*vector[2];
		vectorInCurrentSys[1] = 0.5*Math.pow(a.value(),-1)*Math.pow((-1+1.0/4*Math.pow(a.value(),-2)*Math.pow((Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)+Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)),2)),-1.0/2)*(position[1]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),-1.0/2)+position[1]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),-1.0/2))*vector[0]+(position[2]==0 ? 0 : (-1.0/2*position[2]*Math.pow(a.value(),-1)*Math.pow((1-1.0/4*Math.pow(a.value(),-2)*Math.pow((Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)-1*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)),2)),-1.0/2)*Math.pow(Math.abs(position[2]),-1)*(position[1]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),-1.0/2)-1*position[1]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),-1.0/2))))*vector[1]+position[0]*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)),-1)*vector[2];
		vectorInCurrentSys[2] = 0.5*Math.pow(a.value(),-1)*Math.pow((-1+1.0/4*Math.pow(a.value(),-2)*Math.pow((Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)+Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)),2)),-1.0/2)*(Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),-1.0/2)*(position[2]+a.value())+Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),-1.0/2)*(position[2]-1*a.value()))*vector[0]+(position[2]==0 ? 0 : ((Math.pow(Math.abs(position[2]),-1)*Math.acos(0.5*Math.pow(a.value(),-1)*(Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)-1*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)))-1*Math.pow(position[2],-1)*Math.acos(0.5*Math.pow(a.value(),-1)*(Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)-1*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)))*Math.signum(position[2])-1.0/2*position[2]*Math.pow(a.value(),-1)*Math.pow((1-1.0/4*Math.pow(a.value(),-2)*Math.pow((Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),0.5)-1*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),0.5)),2)),-1.0/2)*Math.pow(Math.abs(position[2]),-1)*(Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((position[2]+a.value()),2)),-1.0/2)*(position[2]+a.value())-1*Math.pow((Math.pow(position[0],2)+Math.pow(position[1],2)+Math.pow((a.value()-1*position[2]),2)),-1.0/2)*(position[2]-1*a.value())))))*vector[1];
	...
	public double metricCoefficient(double[] position, TensorTransformation behavior, int i, int j) {
		...
		if (i < 0 || j < 0) {
			throw new IllegalArgumentException(("Metric coefficient not available for i=%d, j=%d "
					+ "(too low dimension, only 3 dimensions [0,1,2] are supported for prolatespheroidal coordinates)")
					.formatted(i, j));
		} else if (i > 2 || j > 2) {
			throw new IllegalArgumentException(("Metric coefficient not available for i=%d, j=%d "
					+ "(too high dimension, only 3 dimensions [0,1,2] are supported for prolatespheroidal coordinates)")
					.formatted(i, j));
		}
		...
		if (behavior instanceof TensorIndexType tit) {
			return switch (tit) {
				case COVARIANT -> {
					...
					if (i == 2 && j == 2) yield Math.pow(a.value(),2)*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2);
					yield 0;
				}
				case CONTRAVARIANT -> {
	...
	public double jacobianDeterminant(double[] position) {
		validatePosition(position);
		return Math.pow(a.value(),3)*(Math.pow(Math.sin(position[1]),2)+Math.pow(Math.sinh(position[0]),2))*Math.abs(Math.sin(position[1]))*Math.sinh(position[0]);
	}
	...
	public double christoffelSymbol1stKind(double[] position, int i, int j, int k) {
		...
		if (i == 0 && j == 2 && k == 2) return 0.5*Math.pow(a.value(),2)*Math.pow(Math.sin(position[1]),2)*Math.sinh(2*position[0]);
		...
		if (i == 1 && j == 2 && k == 2) return 0.5*Math.pow(a.value(),2)*Math.pow(Math.sinh(position[0]),2)*Math.sin(2*position[1]);
		if (i == 2 && j == 0 && k == 2) return 0.5*Math.pow(a.value(),2)*Math.pow(Math.sin(position[1]),2)*Math.sinh(2*position[0]);
		if (i == 2 && j == 1 && k == 2) return 0.5*Math.pow(a.value(),2)*Math.pow(Math.sinh(position[0]),2)*Math.sin(2*position[1]);
		if (i == 2 && j == 2 && k == 0) return Math.pow(a.value(),2)*Math.pow((-1*Math.cosh(2*position[0])+Math.cos(2*position[1])),-1)*Math.pow(Math.sin(position[1]),2)*(Math.pow(Math.sin(position[1]),2)+Math.pow(Math.sinh(position[0]),2))*Math.sinh(2*position[0]);
		if (i == 2 && j == 2 && k == 1) return Math.pow(a.value(),2)*Math.pow((-1*Math.cosh(2*position[0])+Math.cos(2*position[1])),-1)*Math.pow(Math.sinh(position[0]),2)*(Math.pow(Math.sin(position[1]),2)+Math.pow(Math.sinh(position[0]),2))*Math.sin(2*position[1]);
		return 0;
	}
	...
	public double christoffelSymbol2ndKind(double[] position, int m, int i, int j) {
		...
		if (m == 0 && i == 2 && j == 2) return -1*Math.pow((-1+2*Math.pow(Math.sin(position[1]),2)+Math.cosh(2*position[0])),-1)*Math.pow(Math.sin(position[1]),2)*Math.sinh(2*position[0]);
		...
		if (m == 1 && i == 2 && j == 2) return Math.pow((-1*Math.cosh(2*position[0])+Math.cos(2*position[1])),-1)*Math.pow(Math.sinh(position[0]),2)*Math.sin(2*position[1]);
		if (m == 2 && i == 0 && j == 2) return Math.pow(Math.tanh(position[0]),-1);
		if (m == 2 && i == 1 && j == 2) return Math.pow(Math.tan(position[1]),-1);
		if (m == 2 && i == 2 && j == 0) return Math.pow(Math.tanh(position[0]),-1);
