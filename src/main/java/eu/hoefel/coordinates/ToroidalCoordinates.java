...
public final record ToroidalCoordinates(NavigableSet<Axis> axes, Constant R) implements CoordinateSystem {
	...
	public double[] toBasePoint(double[] position) {
		...
		pointInBase[0] = -R.value()*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-1)*Math.cos(position[2])*Math.sinh(position[0]);
		pointInBase[1] = -R.value()*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-1)*Math.sin(position[2])*Math.sinh(position[0]);
		pointInBase[2] = -R.value()*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-1)*Math.sin(position[1]);
		return pointInBase;
	}
	...
	public double metricCoefficient(double[] position, TensorTransformation behavior, int i, int j) {
		...
		if (behavior instanceof TensorIndexType tit) {
			return switch (tit) {
				case COVARIANT -> {
					if (i == 0 && j == 0) yield Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-4)*(Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2));
					if (i == 1 && j == 1) yield Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-4)*(Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2));
					if (i == 2 && j == 2) yield Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-2)*Math.pow(Math.sinh(position[0]),2);
					yield 0;
				}
				case CONTRAVARIANT -> {
	...
	public double christoffelSymbol1stKind(double[] position, int i, int j, int k) {
		...
		if (i == 0 && j == 0 && k == 0) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-5)*(-Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sinh(position[0]);
		if (i == 0 && j == 0 && k == 1) return -Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-5)*(-Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sin(position[1]);
		if (i == 0 && j == 1 && k == 0) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-5)*(-Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sin(position[1]);
		if (i == 0 && j == 1 && k == 1) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-5)*(-Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sinh(position[0]);
		if (i == 0 && j == 2 && k == 2) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-3)*(-1+Math.cos(position[1])*Math.cosh(position[0]))*Math.sinh(position[0]);
		if (i == 1 && j == 0 && k == 0) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-5)*(-Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sin(position[1]);
		if (i == 1 && j == 0 && k == 1) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-5)*(-Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sinh(position[0]);
		if (i == 1 && j == 1 && k == 0) return -Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-5)*(-Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sinh(position[0]);
		if (i == 1 && j == 1 && k == 1) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-5)*(-Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sin(position[1]);
		if (i == 1 && j == 2 && k == 2) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-3)*Math.pow(Math.sinh(position[0]),2)*Math.sin(position[1]);
		if (i == 2 && j == 0 && k == 2) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-3)*(-1+Math.cos(position[1])*Math.cosh(position[0]))*Math.sinh(position[0]);
		if (i == 2 && j == 1 && k == 2) return  Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-3)*Math.pow(Math.sinh(position[0]),2)*Math.sin(position[1]);
		if (i == 2 && j == 2 && k == 0) return -Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-3)*(-1+Math.cos(position[1])*Math.cosh(position[0]))*Math.sinh(position[0]);
		if (i == 2 && j == 2 && k == 1) return -Math.pow(R.value(),2)*Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-3)*Math.pow(Math.sinh(position[0]),2)*Math.sin(position[1]);
		return 0;
	}
	...
	public double christoffelSymbol2ndKind(double[] position, int m, int i, int j) {
		...
		if (m == 0 && i == 2 && j == 2) return -Math.pow((Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2)),-1)*(-1+Math.cos(position[1])*Math.cosh(position[0]))*(-1*Math.cosh(position[0])+Math.cos(position[1]))*Math.sinh(position[0]);
		if (m == 1 && i == 0 && j == 0) return -Math.pow((Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2)),-1)*Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),-1)*(-1*Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sin(position[1]);
		if (m == 1 && i == 0 && j == 1) return Math.pow((Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2)),-1)*Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),-1)*(-1*Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sinh(position[0]);
		if (m == 1 && i == 1 && j == 0) return Math.pow((Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2)),-1)*Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),-1)*(-1*Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sinh(position[0]);
		if (m == 1 && i == 1 && j == 1) return Math.pow((Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2)),-1)*Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),-1)*(-1*Math.pow((-1*Math.cosh(position[0])+Math.cos(position[1])),2)+2*Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+2*Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2))*Math.sin(position[1]);
		if (m == 1 && i == 2 && j == 2) return -Math.pow((Math.pow((-1+Math.cos(position[1])*Math.cosh(position[0])),2)+Math.pow(Math.sin(position[1]),2)*Math.pow(Math.sinh(position[0]),2)),-1)*Math.pow(Math.sinh(position[0]),2)*(-1*Math.cosh(position[0])+Math.cos(position[1]))*Math.sin(position[1]);
		if (m == 2 && i == 0 && j == 2) return Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-1)*Math.pow(Math.sinh(position[0]),-1)*(-1+Math.cos(position[1])*Math.cosh(position[0]));
		if (m == 2 && i == 1 && j == 2) return Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-1)*Math.sin(position[1]);
		if (m == 2 && i == 2 && j == 0) return Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-1)*Math.pow(Math.sinh(position[0]),-1)*(-1+Math.cos(position[1])*Math.cosh(position[0]));
		if (m == 2 && i == 2 && j == 1) return Math.pow((-Math.cosh(position[0])+Math.cos(position[1])),-1)*Math.sin(position[1]);
		return 0;
	}
